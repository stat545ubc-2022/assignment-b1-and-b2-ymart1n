...
The first three tests are testing if the function gives the expected output. The last two tests are testing whether the function throws the expected errors. The output and errors are similar to the examples shown above.
